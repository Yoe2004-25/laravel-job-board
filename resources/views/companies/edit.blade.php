                ...
                <form method="POST" action="{{ route('companies.update', $company->id) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('number_employees') is-invalid @enderror" 
                                   id="number_employees" name="number_employees" value="{{ old('number_employees', $company->number_employees) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('website_name') is-invalid @enderror" 
                                   id="website_name" name="website_name" value="{{ old('website_name', $company->website_name) }}">
                            @error('website_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('number_phone') is-invalid @enderror" 
                               id="number_phone" name="number_phone" value="{{ old('number_phone', $company->number_phone) }}">
                        @error('number_phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
